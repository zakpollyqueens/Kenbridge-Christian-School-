...
const previewSite =
    document.getElementById("previewSite");
...
const launchDateLabel =
    document.getElementById("launchDateLabel");


/*
   TEMPORARY LAUNCH DATE

   Change this when the official date
   is confirmed.
*/

const launchDate =
    new Date("2026-09-01T08:00:00").getTime();
...
function updateCountdown() {
    ...
    if (difference <= 0) {
        ...
        if (launchScreen) {
            launchScreen.classList.add("launched");
        }
