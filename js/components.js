...
function loadFooter() {
     ...
     * footer.html is inside /components/
     *
     * Therefore ../components/footer.html is correct
     * regardless of whether the current page is index.html
     * or a page inside /page/.
     */
...
function resolveProjectPath(path) {
    ...
    /*
     * Leave external links, telephone links,
     * email links and anchors untouched.
     */
    if (
    ...
    /*
     * Always resolve internal links from the
