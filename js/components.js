...
/*
 * IMPORTANT:
 * components.js is inside /js/
 *
 * Therefore the project root is one level above
 * the folder containing this JavaScript file.
 *
...
const COMPONENTS_SCRIPT =
    document.currentScript;

const SITE_ROOT = COMPONENTS_SCRIPT
    ? new URL("../", COMPONENTS_SCRIPT.src)
...
function loadFooter() {
    ...
    /*
     * footer.html is inside:
     *
     * /components/footer.html
     *
     * SITE_ROOT points to the actual project root.
     */
...
function resolveProjectPath(path) {
    ...
    /*
     * ALWAYS resolve internal links from
     * the actual GitHub Pages project root.
     *
     * Example:
     *
     * page/about.html
     ...
     * becomes:
     *
     * /Kenbridge-Christian-School-/page/about.html
     *
     * instead of:
     *
     * /Kenbridge-Christian-School-/page/page/about.html
     */
