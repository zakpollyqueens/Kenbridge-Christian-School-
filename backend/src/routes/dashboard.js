...
router.get("/staff",async(req,res)=>{
  try{
    ...
    try{
      ...
      notificationStats=
        notificationResult.rows[0]||notificationStats;

    }catch(error){
      console.log(
        "DASHBOARD NOTIFICATION STATS SKIPPED:",
        error.message
      );
    }
    ...
    try{
      ...
      announcementStats=
        announcementResult.rows[0]||announcementStats;
    ...
    try{
      ...
      articleStats=
        articleResult.rows[0]||articleStats;
    ...
    try{
      ...
      studentStats=
        studentResult.rows[0]||studentStats;
